!function (e) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), function (e) {
        var t, o = i(3), s = (i.n(o), i(4));
        i.n(s);
        (t = e)(document).ready(function () {
            if (t(".sliders").slick(), t(".faqs-item > h3").click(function () {
                var e = t(this).parent(".faqs-item"), i = t(this).closest(".faqs");
                e.hasClass("active") ? (e.removeClass("active"), e.find("div").slideUp()) : (i.find(".faqs-item").removeClass("active"), i.find(".faqs-item > div").slideUp(), e.addClass("active"), e.find("div").slideDown())
            }), t(".calculater-more").click(function (e) {
                e.preventDefault();
                var i = t(".calculater"), o = t("#form-options");
                i.hasClass("show-more") ? (i.removeClass("show-more"), o.slideUp()) : (i.addClass("show-more"), o.slideDown())
            }), t(".hide-calculater").click(function (e) {
                e.preventDefault();
                var i = t(".calculater"), o = t("#form-options");
                i.removeClass("show-more"), o.slideUp()
                ...
                preloader: !1,
                fixedContentPos: !1
            }), t(".open-popup").magnificPopup({type: "inline"}), t(".has-collapse").click(function () {
                var e = t(this).parent(".widget");
                e.toggleClass("close"), e.find(".widget-body").slideToggle()
            }), t(".filter-color a").click(function (e) {
                e.preventDefault(), t(this).toggleClass("checked")
            }), t(".has-show-more").each(function () {
                var e = t(this).height(), i = 0, o = t(this).data("show-item");
                t(this).find(".checkbox-wrap:lt(" + o + ")").each(function () {
                    i += t(this).outerHeight(!0)
                }), e > i && (t(this).wrapInner('<div class="show-more-inner" style="height: ' + i + 'px"></div>'), t(this).append('<a href="#" class="more-less">Show more</a>'), t(this).data("height", i))
            }), t(".more-less").click(function (e) {
                e.preventDefault();
                var i = t(this).parent(".has-show-more"), o = i.data("height");
                t(this).hasClass("open") ? (t(this).text("Show more"), t(this).removeClass("open"), i.find(".show-more-inner").height(o)) : (t(this).text("Show less"), t(this).addClass("open"), i.find(".show-more-inner").height("auto"))
            }), t(".heading-sidebar > a, .filter-button").click(function (e) {
                e.preventDefault(), t(".shop-main").toggleClass("open-sidebar")
            }), t(".more-text").click(function (e) {
                e.preventDefault(), t(".content-more").hasClass("open") ? (t(".content-more").removeClass("open"), t(this).text("[more]")) : (t(".content-more").addClass("open"), t(this).text("[less]"))
            }), t(".product-color ul li a").click(function (e) {
                e.preventDefault(), t(".color-active").css("display", "inline-block"), t(".color-active .color").css("background", t(this).css("background")), t(".color-active .text").text(t(this).text()), t(".product-color ul li a").removeClass("active"), t(this).addClass("active")
            }), t(".sizes").length) {
                var e = [];
                t(".size ul li").each(function () {
                    e.push(t(this).find("a").text())
                }), t(".sizes ul li a").click(function (i) {
                    i.preventDefault();
                    var o = t(this);
                    -1 !== t.inArray(o.text(), e) ? (e = t.grep(e, function (e) {
                        return e != o.text()
                    }), o.removeClass("active")) : (e.push(o.text()), o.addClass("active"));
                    var s = "";
                    t.each(e, function (e, t) {
                        s += "<li>" + t + "</li>"
                    }), t(".sizes-select").html(s)
                })
            }
            t(".tab-wrap .tab-heading a").click(function (e) {
                e.preventDefault();
                var i = t(this).parents(".tab-wrap"), o = t(this).attr("href");
                i.find(".tab-panel > div").removeClass("active"), i.find(".tab-heading > ul > li").removeClass("active"), t(this).parent("li").addClass("active"), t(o).addClass("active")
            }), t(".rating-button a").mouseenter(function () {
                t(this).addClass("starred"), t(this).prevAll(".star").addClass("starred")
            }), t(".rating-button a").mouseleave(function () {
                t(".rating-button .starred").each(function () {
                    t(this).removeClass("starred")
                })
            }), t(".rating-button a").click(function (e) {
                e.preventDefault(), t(".rating-button a.current").removeClass("current"), t(this).addClass("current"), t(this).prevAll(".star").addClass("current")
            }), t(".gallery").slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                arrows: !1,
                ...
                verticalSwiping: !0,
                focusOnSelect: !0,
                responsive: [{breakpoint: 1199, settings: {vertical: !1, verticalSwiping: !1}}]
            }), t(".parent-menu").find("> a, > h3").append('<span class="toogle-dropdown"></span>'), t(".toogle-dropdown").click(function (e) {
                e.preventDefault(), t(this).closest(".parent-menu").toggleClass("open")
            }), t(".toogle-menu").click(function (e) {
                e.preventDefault(), t("body").toggleClass("show-menu")
            })
        })
    }.call(t, i(0))
}, function (e, t, i) {
    ...
    !function (r) {
        "use strict";
        s = [i(0)], void 0 === (n = "function" == typeof (o = r) ? o.apply(t, s) : o) || (e.exports = n)
    }(function (e) {
        "use strict";
        var t = window.Slick || {};
        (t = function () {
            ...
            if (!0 === s.options.centerMode ? !0 === s.options.infinite ? o = (i = s.currentSlide + (s.options.slidesToShow / 2 + 1)) + s.options.slidesToShow + 2 : (i = Math.max(0, s.currentSlide - (s.options.slidesToShow / 2 + 1)), o = s.options.slidesToShow / 2 + 1 + 2 + s.currentSlide) : (i = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide, o = Math.ceil(i + s.options.slidesToShow), !0 === s.options.fade && (i > 0 && i--, o <= s.slideCount && o++)), t = s.$slider.find(".slick-slide").slice(i, o), "anticipated" === s.options.lazyLoad) for (var r = i - 1, a = o, l = s.$slider.find(".slick-slide"), d = 0; d < s.options.slidesToScroll; d++) r < 0 && (r = s.slideCount - 1), t = (t = t.add(l.eq(r))).add(l.eq(a)), r--, a++;
            ...
            if (t = t || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === e)) if (!1 === t && d.asNavFor(e), o = e, a = d.getLeft(o), r = d.getLeft(d.currentSlide), d.currentLeft = null === d.swipeLeft ? r : d.swipeLeft, !1 === d.options.infinite && !1 === d.options.centerMode && (e < 0 || e > d.getDotCount() * d.options.slidesToScroll)) !1 === d.options.fade && (o = d.currentSlide, !0 !== i && d.slideCount > d.options.slidesToShow ? d.animateSlide(r, function () {
                d.postSlide(o)
            }) : d.postSlide(o)); else if (!1 === d.options.infinite && !0 === d.options.centerMode && (e < 0 || e > d.slideCount - d.options.slidesToScroll)) !1 === d.options.fade && (o = d.currentSlide, !0 !== i && d.slideCount > d.options.slidesToShow ? d.animateSlide(r, function () {
                d.postSlide(o)
            }) : d.postSlide(o)); else {
...
* Copyright (c) 2016 Dmitry Semenov; */
        a = function (e) {
            var t, i, s, n, r, a, l = function () {
            }, d = !!o, c = e(window), p = function (e, i) {
                t.ev.on("mfp" + e + ".mfp", i)
            }, u = function (t, i, o, s) {
            ...
            l.prototype = {
                constructor: l, init: function () {
                    ...
                    if (!1 === i.isObj) {
                        ...
                        var n, a = i.items;
                        for (o = 0; o < a.length; o++) if ((n = a[o]).parsed && (n = n.el[0]), n === i.el[0]) {
                            t.index = o;
                            break
                        }
                    ...
                    if (!t.isOpen) {
                        ...
                        f("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (p("MarkupParse", function (e, t, i, o) {
                            i.close_replaceWith = h(o.type)
                        }), r += " mfp-close-btn-in") : t.wrap.append(h())), t.st.alignTop && (r += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
                        ...
                        return t.isIE7 && (w += " mfp-ie7"), w && t._addClassToMFP(w), t.updateItemHTML(), f("BuildControls"), e("html").css(v), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function () {
                    ...
                    var o = i.type;
                    if (f("BeforeChange", [t.currItem ? t.currItem.type : "", o]), t.currItem = i, !t.currTemplate[o]) {
                        var s = !!t.st[o] && t.st[o].markup;
                        f("FirstMarkupParse", s), t.currTemplate[o] = !s || e(s)
                    }
                    n && n !== i.type && t.container.removeClass("mfp-" + n + "-holder");
                    var r = t["get" + o.charAt(0).toUpperCase() + o.slice(1)](i, t.currTemplate[o]);
                    t.appendContent(r, o), i.preloaded = !0, f("Change", i), n = i.type, t.container.prepend(t.contentContainer), f("AfterChange")
                    ...
                    return s.type = o || t.st.type || "inline", s.index = i, s.parsed = !0, t.items[i] = s, f("ElementParse", s), t.items[i]
                    ...
                    if (t.preloader) {
                        ...
                        f("UpdateStatus", s), e = s.status, o = s.text, t.preloader.html(o), t.preloader.find("a").on("click", function (e) {
                    ...
                    return (t.isIE7 ? s.height() : document.body.scrollHeight) > (e || c.height())
                }, _setFocus: function () {
                    ...
                    var s;
                    o.data && (i = e.extend(o.data, i)), f("MarkupParse", [t, i, o]), e.each(i, function (i, o) {
                ...
                if ("string" == typeof i) if ("open" === i) {
                    var s, n = d ? o.data("magnificPopup") : o[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
                    n.items ? s = n.items[r] : (s = o, n.delegate && (s = s.find(n.delegate)), s = s.eq(r)), t._openClick({mfpEl: s}, o, n)
                } else t.isOpen && t[i].apply(t, Array.prototype.slice.call(arguments, 1)); else i = e.extend(!0, {}, i), d ? o.data("magnificPopup", i) : o[0].magnificPopup = i, t.addGroup(o, i);
                return o
            };
            var v, g, w, k = function () {
                w && (g.after(w.addClass(v)).detach(), w = null)
            };
                    ...
                    initInline: function () {
                        ...
                        if (k(), i.src) {
                            ...
                            if (n.length) {
                                ...
                                r && r.tagName && (g || (v = s.hiddenClass, g = u(v), v = "mfp-" + v), w = n.after(g).detach().removeClass(v)), t.updateStatus("ready")
            ...
            e.magnificPopup.registerModule("ajax", {
                options: {
                    ...
                    initAjax: function () {
                        t.types.push("ajax"), y = t.st.ajax.cursor, p("Close.ajax", C), p("BeforeChange.ajax", C)
                    }, getAjax: function (i) {
                        y && e(document.body).addClass(y), t.updateStatus("loading");
                        var o = e.extend({
                            url: i.src, success: function (o, s, n) {
                                var r = {data: o, xhr: n};
                                f("ParseAjax", r), t.appendContent(e(r.data), "ajax"), i.finished = !0, S(), t._setFocus(), setTimeout(function () {
            ...
            e.magnificPopup.registerModule("image", {
                options: {
                    ...
                    initImage: function () {
                        ...
                        t.types.push("image"), p("Open" + o, function () {
                            "image" === t.currItem.type && i.cursor && e(document.body).addClass(i.cursor)
                        }), p("Close" + o, function () {
                            i.cursor && e(document.body).removeClass(i.cursor), c.off("resize.mfp")
                        }), p("Resize" + o, t.resizeImage), t.isLowIE && p("AfterChange", t.resizeImage)
                        ...
                        var i = 0, o = e.img[0], s = function (n) {
                            T && clearInterval(T), T = setInterval(function () {
                                o.naturalWidth > 0 ? t._onImageHasSize(e) : (i > 200 && clearInterval(T), 3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500))
                            }, n)
                        };
                        s(1)
                    }, getImage: function (i, o) {
                        var s = 0, n = function () {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, f("ImageLoadComplete")) : ++s < 200 ? setTimeout(n, 100) : r())
                        }, r = function () {
                        ...
                        }, i), t.resizeImage(), i.hasSize ? (T && clearInterval(T), i.loadError ? (o.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", i.src))) : (o.removeClass("mfp-loading"), t.updateStatus("ready")), o) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, o.addClass("mfp-loading"), t.findImageSize(i)), o)
                    }
                }
            });
            var b;
            e.magnificPopup.registerModule("zoom", {
                options: {
                    ...
                    initZoom: function () {
                        ...
                        if (i.enabled && t.supportsTransition) {
                            ...
                            p("BuildControls" + o, function () {
                                if (t._allowZoom()) {
                                    ...
                                    (n = a(e)).css(t._getOffset()), t.wrap.append(n), s = setTimeout(function () {
                        ...
                        var a = {width: o.width(), height: (d ? o.innerHeight() : o[0].offsetHeight) - r - n};
                        return void 0 === b && (b = void 0 !== document.createElement("p").style.MozTransform), b ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, a.top = s.top), a
                    }
                }
            });
            var $ = function (e) {
            ...
            e.magnificPopup.registerModule("gallery", {
                options: {
                    ...
                    initGallery: function () {
                        ...
                        r += " mfp-gallery", p("Open" + o, function () {
                        ...
                        }), p("MarkupParse" + o, function (e, o, s, n) {
                            var r = t.items.length;
                            s.counter = r > 1 ? P(i.tCounter, n.index, r) : ""
                        }), p("BuildControls" + o, function () {
                        ...
                        var e, i = t.st.gallery.preload, o = Math.min(i[0], t.items.length),
                        ...
                        if (i = x(i), !t.items[i].preloaded) {
                            var o = t.items[i];
                            o.parsed || (o = t.parseEl(i)), f("LazyLoad", o), "image" === o.type && (o.img = e('<img class="mfp-img" />').on("load.mfploader", function () {
                                o.hasSize = !0
        ...
        }, n = [i(0)], void 0 === (r = "function" == typeof (s = a) ? s.apply(t, n) : s) || (e.exports = r)
    }).call(t, i(0))
}, function (e, t) {
}]);